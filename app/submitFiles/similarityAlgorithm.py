# This file creates password similarity algorithm for checking new passwords
# Similarity checks follow John the Ripper password mangling rules and each rule has its inverse
# Jacob Shoaf
